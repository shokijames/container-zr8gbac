...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-zr8gbac.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-zr8gbac.containers.anotherwebservice.com/
...
```
git clone git@github.com:shokijames/container-zr8gbac.git
cd container-zr8gbac
```
...
```
docker attach container-zr8gbac
```
